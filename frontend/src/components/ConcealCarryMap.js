...
function ConcealCarryMap() 
{
   ...
   const [minAgeToConcealCarry, setMinAgeToConcealCarry] = useState('');

   // Old green color for no permit #388E3C, #0088d1
   // Old blue for permit required  #0000F, #0D47A1
   // red colors: #D32F2F #ac0029 #922100
   let shapeSetting = {
      colorValuePath: 'Right to Carry Law',
      colorMapping: [
         { value: 'No Permit Required', color: '#0088d1' },
         { value: 'Permit Required', color: '#00245e'},
   ...
   const shapeSelected = (args) => {
         if (args.shapeData !== isNullOrUndefined) {
            ...
            setMinAgeToConcealCarry(args.data.MinAgeToConcealCarry);
         }
   };
      ...
      <div>
         ...
         <div>
            ...
            shapeSelected={shapeSelected.bind(this)}>
               ...
               {/* Default selection setting grey */}
               ...
               <LayersDirective>
                  <LayerDirective shapeData={usa} shapePropertyPath='name' shapeDataPath='State' dataSource={datasource} 
                     tooltipSettings={{ visible: true, valuePath: 'name'}} 
                     highlightSettings={{ enable: true, fill: '', opacity: .7, border: { color: 'white', width: 2 }}} 
                     selectionSettings={{ enable: true, fill: '', opacity: 1, border: { color: 'white', width: 2 }}} 
         ...
         <div className="popup" id="closepopu" style={{ display: popup }}>
         <label className="text-lg font-bold" id="winner" style={{ color: '#666666', fontFamily: 'Roboto'}}>{state}'s Gun Laws Overview
            <br></br>Minimum Age for Concealed Carry: {minAgeToConcealCarry}</label>
            ...
            <table className="border border-solid" role='none' style={{ marginTop: '5px', width: 'auto' }}>
               ...
               <tr className="border border-solid">
                  <th className="border border-solid">
                     <label className="text-sm font-normal">Requirements </label>
                  </th>
                  <th className="border border-solid">
...
export default ConcealCarryMap;
